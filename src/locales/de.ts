export default {
  ...
  about: {
    ...
    myWork: {
      ...
      current: "Diese Projekte waren mehr als technische Übungen; sie waren Lektionen in Verantwortung und der realen Auswirkung von Code. Derzeit kanalisiere ich meine Leidenschaft für Erforschung in akademische Forschung. Ich entwickle <strong>\"Synapse\"</strong>, ein Firefox-Plugin, das eine neuartige Technik aus der Robotik anwenden möchte, um Benutzerinteraktionen im Browser zu modellieren und zu verstehen - eine Herausforderung, die mich dazu bringt, über konventionelle Webentwicklung hinaus zu denken und Verbindungen zwischen unterschiedlichen Bereichen zu ziehen.",
    },
    philosophy: {
      title: "Meine Philosophie",
      intro: "Meine praktische Erfahrung hat meine Sicht auf KI tiefgreifend geprägt. Ich sehe LLMs nicht als Orakel, die definitive Antworten liefern. Stattdessen konzeptualisiere ich sie als:",
      echoChambersQuote: "<strong>\"Echokammern der Zivilisation\"</strong> - umfangreiche, komprimierte Archive menschlichen Wissens und Diskurses. Sie denken nicht; sie reflektieren.",
      mission: "Diese Perspektive definiert meine Mission: ein:",
      knowledgeArchitectQuote: "<strong>\"Wissensarchitekt\"</strong> zu werden. Meine Arbeit besteht nicht nur darin, Modelle zu erstellen, sondern zu lernen, wie man ihnen bessere Fragen stellt, Rahmenwerke zu entwerfen, die uns helfen, durch diese immense Echokammer zu navigieren, und neue Wege für das Lernen zu konstruieren.",
      education: "Ich bin besonders leidenschaftlich daran interessiert, wie sich dies auf die Bildung anwenden lässt, und glaube, dass KI das Werkzeug sein kann, das uns endlich von der \"Angststeuer\" des Auswendiglernens befreit und eine Zukunft personalisierter, neugiergetriebener Entdeckung ermöglicht.",
    },
    beyondCode: {
      title: "Jenseits des Codes",
      content: "Ich bin ein unabhängiger Denker, ein beharrlicher Problemlöser und endlos neugierig auf das, was vor uns liegt. Diese Philosophie des langfristigen, prinzipiengeleiteten Wachstums erstreckt sich über meinen Code hinaus - von meiner geduldigen, global diversifizierten Anlagestrategie bis hin zu meinem Glauben an den Zinseszinseffekt des täglichen Lernens. Und ja, wenn ich nicht die Architektur neuronaler Netzwerke erforsche, bin ich oft in den Welten verloren, die Hayao Miyazaki und Isao Takahata geschaffen haben, und ziehe Inspiration aus ihrer Mischung aus Kunstfertigkeit, Technik und Herz.",
      callToAction: "Wenn Sie sich für die Zukunft von KI, Bildung interessieren oder einfach mit einem Mitstreiter und Denker in Kontakt treten möchten, würde ich mich freuen, von Ihnen zu hören.",
    },
    connect: {
      title: "Verbinden",
      github: "GitHub",
    ...
    capabilities: {
      ...
      ml: {
        ...
        description: "ViT- und CNN-Expertise mit medizinischen Bildgebungsanwendungen",
      },
      fullstack: {
    ...
    values: {
      ...
      knowledgeArchitect: {
        ...
        description: "Ordnung und Klarheit aus Komplexität schaffen, Wege zum Verständnis bauen.",
      },
      crossDomain: {
        title: "Bereichsübergreifende Verbindungen",
        description: "Unterschiedliche Bereiche überbrücken, um Innovation an ihren Schnittpunkten zu entdecken.",
      },
      humanCentric: {
        title: "Menschenzentrierte Technologie",
        description: "Sicherstellen, dass Technologie grundlegenden menschlichen Bedürfnissen und der Würde dient.",
      },
      independentThinking: {
        title: "Unabhängiges Denken",
        description: "Standardantworten hinterfragen und einzigartige konzeptuelle Rahmen konstruieren.",
      },
    },
  },
} as const;

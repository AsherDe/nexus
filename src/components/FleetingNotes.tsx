  ...
  const notes = [
    {
      id: 1,
      content:
        "Server-side components in Next.js 15 are game-changers for performance",
      timestamp: "2h ago",
    },
    {
      id: 2,
    ...
    },
    {
      id: 4,
      content:
        "The compound effect applies to code quality as much as investing",
      timestamp: "2d ago",
    },
  ];
    ...
    <Widget title="Fleeting Notes">
      <div className="space-y-3">
        {notes.map((note) => (
          <div
            key={note.id}
            className="border-l-2 border-color-separator pl-3 space-y-1"
          >

              ...
              <div key={holding.symbol} className="space-y-1">
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <div className={`text-sm font-medium ${holding.changePercent && holding.changePercent >= 0 ? 'text-green-500' : 'text-red-500'}`}>
                      {holding.changePercent ? `${holding.changePercent >= 0 ? '+' : ''}${holding.changePercent.toFixed(2)}%` : '0.00%'}
                    </div>
                  </div>
                </div>
